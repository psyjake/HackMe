...
import hackme.screens.ScreenReturn;
...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        ((StartScreenController)loader.getController()).returner = new ScreenReturn() {
            @Override
    ...
    private void startScreenReturn(String message) throws Exception {
        if (message.equals("start")) {
            ...
            // Deal with screen returning control back
            ((GameScreenController)loader.getController()).returner = new ScreenReturn() {
                @Override
                public void onScreenReturn(String message) throws Exception {
